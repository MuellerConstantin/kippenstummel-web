...
import { useCvmMapRegisterView } from "@/contexts/CvmMapViewProvider";
...
export function CvmMapRegisterOverlay({
  ...
  return (
    <>
      <div className="absolute top-2.5 left-1/2 z-[50000] w-fit -translate-x-1/2 px-2">
      ...
      />
      <div className="pointer-events-auto absolute bottom-14 left-1/2 z-[50000] block h-fit w-fit -translate-x-1/2 px-2 sm:bottom-9 lg:bottom-8">
